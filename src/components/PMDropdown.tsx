...
export function PMDropdown() {
  ...
  return (
    <>
      ...
      <div
        className={clsx(
          'absolute top-full right-0 mt-1.5 min-w-35 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-lg dark:shadow-black/30 py-1 transition-all duration-150 origin-top-right',
