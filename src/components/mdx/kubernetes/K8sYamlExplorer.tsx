...
export function K8sYamlExplorer({ sectionId }: { sectionId: string }) {
  ...
  const { yamlLines, yamlFileName } = section
  ...
  return (
    <div className="flex gap-4 flex-wrap my-6">
      ...
      <div className="flex-1 basis-60 min-w-60">
        {activeLine !== null && yamlLines[activeLine]?.note ? (
