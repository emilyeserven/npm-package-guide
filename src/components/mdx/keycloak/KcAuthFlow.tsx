import { KC_PKCE_FLOW_STEPS } from '../../../data/keycloakData'
import type { KcFlowStep } from '../../../data/keycloakData'
import { TimelineFlow } from '../TimelineFlow'

export function KcAuthFlow() {
  return (
    <TimelineFlow<KcFlowStep>
      items={KC_PKCE_FLOW_STEPS}
      className="mb-7"
      itemGap="gap-4"
      renderIndicator={(f) => (
        <div
