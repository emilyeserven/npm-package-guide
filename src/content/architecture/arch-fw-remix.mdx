...
<SectionNote>
Remix merged into React Router v7 in 2024.<FnRef n={1} /> New projects should use <NavLink to="arch-fw-react-router" /> directly. This page covers Remix&apos;s contributions and ideas, which live on in React Router v7.
</SectionNote>
