...
<h2 className="section-subheading" id="toc-cycle">{'\u{1F501}'} The request-response cycle</h2>
...
<h2 className="section-subheading" id="toc-diagram">{'\u{1F4CA}'} Data flow diagram</h2>
...
<h2 className="section-subheading" id="toc-key">{'\u2705'} Key takeaways</h2>

<div className="section-list">
<ColItem>**The frontend never talks to the database directly.** All data goes through the server framework, which acts as a gatekeeper — validating requests, enforcing permissions, and shaping responses.</ColItem>
