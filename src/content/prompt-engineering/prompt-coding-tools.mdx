...
title: "AI Coding Tools Compared 🛠️"
...
linkRefs:
  ...
  - id: "cursor-docs"
    note: "Cursor documentation — AI-enhanced IDE built on VS Code."
  - id: "lovable-docs"
    note: "Lovable documentation — browser-based AI app builder."
  - id: "github-copilot-docs"
    note: "GitHub Copilot documentation — AI pair programmer for existing editors."
  - id: "windsurf-docs"
    note: "Windsurf documentation — AI IDE with Cascade agentic flows."
  - id: "bolt-docs"
    note: "Bolt documentation — browser-based AI development environment."
---
