...
export const badgeMap: Record<string, { cls: string; label: string }> = {
  ...
  "guide:ai-infra": { cls: "bg-sky-50 text-sky-700 dark:bg-sky-500/15 dark:text-sky-300", label: "AI Infra Guide" },
  // Topic
  ...
  "cat:ai-infrastructure": { cls: "bg-sky-100 text-sky-800 dark:bg-sky-500/15 dark:text-sky-300", label: "AI Infrastructure" },
};
...
export const guideTags = new Set(["guide:npm-package", "guide:architecture", "guide:testing", "guide:prompt-engineering", "guide:ci-cd", "guide:auth", "guide:ai-infra"]);
