...
export const sections: Section[] = [
  ...
  },
  {
    ...
    intro: "Before you write any code, you need to decide how your project will be structured at the repo level. In the JavaScript ecosystem, there are two main approaches: a monolith (one project, one package.json, everything in one place) and a monorepo (one Git repo containing multiple independent packages that can be built, tested, and published separately). This choice affects your tooling, your dependency management, and how you collaborate with other developers." +
      "<h2 class='section-subheading' id='toc-monorepo-structure'>Sample Monorepo Structure</h2>" +
      "A monorepo organizes each package as an independent project inside a shared <strong>packages/</strong> directory. Each package has its own <strong>src/</strong>, <strong>dist/</strong>, <strong>package.json</strong>, and <strong>tsconfig.json</strong> \u2014 the same structure you'd use for a standalone project." +
      "<pre class='code-block'>my-org/\n\u251C\u2500\u2500 packages/\n\u2502   \u251C\u2500\u2500 utils/                 # @myorg/utils\n\u2502   \u2502   \u251C\u2500\u2500 src/\n\u2502   \u2502   \u2502   \u2514\u2500\u2500 index.ts\n\u2502   \u2502   \u251C\u2500\u2500 dist/\n\u2502   \u2502   \u251C\u2500\u2500 package.json\n\u2502   \u2502   \u2514\u2500\u2500 tsconfig.json\n\u2502   \u251C\u2500\u2500 components/            # @myorg/components\n\u2502   \u2502   \u251C\u2500\u2500 src/\n\u2502   \u2502   \u2502   \u2514\u2500\u2500 Button.tsx\n\u2502   \u2502   \u251C\u2500\u2500 dist/\n\u2502   \u2502   \u251C\u2500\u2500 package.json\n\u2502   \u2502   \u2514\u2500\u2500 tsconfig.json\n\u2502   \u2514\u2500\u2500 eslint-config/         # @myorg/eslint-config\n\u2502       \u251C\u2500\u2500 src/\n\u2502       \u2502   \u2514\u2500\u2500 index.ts\n\u2502       \u251C\u2500\u2500 package.json\n\u2502       \u2514\u2500\u2500 tsconfig.json\n\u251C\u2500\u2500 .github/\n\u2502   \u2514\u2500\u2500 workflows/\n\u2502       \u2514\u2500\u2500 ci.yml\n\u251C\u2500\u2500 package.json           # root \u2014 workspace config only\n\u251C\u2500\u2500 pnpm-workspace.yaml    # declares packages/*\n\u2514\u2500\u2500 tsconfig.json          # shared base config</pre>" +
      "<div class='section-note'>\u{1F4CB} Each package inside <strong>packages/</strong> follows the same single-package folder structure described in the <button class='inline-nav-link' data-nav='dist'>\u{1F4C1} Folder Structure</button> section. The root <strong>package.json</strong> typically only contains workspace configuration and shared dev scripts \u2014 it doesn't publish anything itself.</div>",
    customColumns: true,
    ...
    col2: [
      ...
      "Common workspace packages include: shared <button class='inline-nav-link' data-nav='ci-linting'>\u{1F9F9} ESLint configs</button>, component libraries, and utility libraries. If workspace packages depend on each other (e.g., your components package imports from your utils package), a tool like Lerna" + fnRef(5) + " or Turborepo" + fnRef(3) + " helps manage the dependency build order so packages are built in the right sequence.",
      "Monorepos aren't just for npm packages \u2014 they work for web apps too. A common pattern is splitting a full-stack app into workspace packages: a <strong>client</strong> package (your React/Vue frontend), a <strong>server</strong> package (an Express or Fastify app that handles secrets, auth, and server-only logic), and a shared <strong>types</strong> package that defines interfaces used by both \u2014 keeping your client and server in sync without duplicating type definitions."
    ],
